...
sudo cp -R /root/blago_conf/Scripts ./
sudo cp -R /root/blago_conf/Service ./
sudo cp -R /root/blago_conf/Nginx ./
sudo cp -R /root/blago_conf/html_for_bot ./
sudo cp /root/blago_conf/main.py ./
sudo chown -R $USER:$USER ./
#sudo rm -rf /root/blago_conf
...
echo
sudo cp /home/$USER/$proj_name/Service/blago_conf_bot.service /lib/systemd/system/blago_conf_bot.service
sudo systemctl daemon-reload
sudo systemctl enable blago_conf_bot.service
sudo systemctl start blago_conf_bot.service
